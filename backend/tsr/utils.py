...
def save_video(
    ...
    """Save frames as video using imageio with ffmpeg or pyav."""
    frames = [np.array(frame) for frame in frames]
    
    # Explicitly use FFMPEG plugin for MP4 export
    try:
        # Try FFMPEG first (best quality/compatibility)
        ...
        try:
            ...
            print(f"Warning: Saved as GIF instead of MP4: {e2}")
